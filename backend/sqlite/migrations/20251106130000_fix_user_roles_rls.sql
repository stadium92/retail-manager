-- Auto-generated from 20251106130000_fix_user_roles_rls.sql
...
DROP POLICY IF EXISTS "Masters can insert roles in their stores" ON user_roles;
...
WITH CHECK (
  ...
  (
    ...
    NOT EXISTS (
      SELECT 1
      FROM user_roles existing_roles
...
DROP POLICY IF EXISTS "Masters can delete roles in their stores" ON user_roles;
