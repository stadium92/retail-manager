...
try {
  ...
  // runs the ensureColumn() ALTER TABLE backfills that bring an older
...
// an empty startup log. Catching it here cannot make the query work, but it
// converts a silent, undiagnosable process death into a precise statement of
