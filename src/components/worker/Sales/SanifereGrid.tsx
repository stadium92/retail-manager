...
export function SanifereGrid({
  ...
  return (
    ...
    >
      <div 
        className="bg-[hsl(50,100%,45%)] text-black dark:bg-[#0D0D0D] dark:text-white dark:border-b-2 dark:border-[#F5C518]/30 font-mono text-sm font-bold grid border-b-2 border-black sticky top-0 z-10 shadow-md"
        style={{ gridTemplateColumns }}
      >
        <div className="px-1 py-1 border-r border-black/30 dark:border-[#F5C518]/15 text-center relative">
          S
          <ResizeHandle colId="s" />
        </div>
        
        <div className="px-2 py-1 border-r border-black/30 dark:border-[#F5C518]/15 relative flex justify-between items-center uppercase">
        ...
        <div className="px-2 py-1 border-r border-black/30 dark:border-[#F5C518]/15 text-center relative uppercase">
          {t('pos.grid.headers.sku')}
          <ResizeHandle colId="code" />
        </div>
        
        <div className="px-1 py-1 border-r border-black/30 dark:border-[#F5C518]/15 text-center relative uppercase">
        ...
        <div className="px-2 py-1 border-r border-black/30 dark:border-[#F5C518]/15 flex items-center justify-end gap-1 relative uppercase">
          {onGlobalTierChange && enablePriceTiers ? (
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="dark:bg-[#111111] dark:border-[#F5C518]/25 dark:text-white">
                <DropdownMenuLabel className="dark:text-[#F5C518]">Global Price Tier</DropdownMenuLabel>
                <DropdownMenuSeparator className="dark:bg-[#F5C518]/20" />
                <DropdownMenuItem onClick={() => onGlobalTierChange(1)} className="dark:hover:bg-[#F5C518]/10 cursor-pointer">
                  <span>Detail (Price 1)</span>
                </DropdownMenuItem>
                <DropdownMenuItem onClick={() => onGlobalTierChange(2)} className="dark:hover:bg-[#F5C518]/10 cursor-pointer">
                  <span>Discount (Price 2)</span>
                </DropdownMenuItem>
                <DropdownMenuItem onClick={() => onGlobalTierChange(3)} className="dark:hover:bg-[#F5C518]/10 cursor-pointer">
                  <span>Bulk (Price 3)</span>
                </DropdownMenuItem>
                <DropdownMenuItem onClick={() => onGlobalTierChange(4)} className="dark:hover:bg-[#F5C518]/10 cursor-pointer">
        ...
        <div className="px-1 py-1 border-l border-black/30 dark:border-[#F5C518]/15"></div>
      </div>

      <div className="flex-1 bg-[hsl(220,100%,35%)] dark:bg-[#111111] overflow-y-auto overflow-x-hidden">
        {items.length === 0 ? (
