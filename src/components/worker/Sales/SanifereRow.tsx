  ...
  return (
    <div
      ...
      className={cn('grid font-mono text-sm border-b border-white/20 cursor-pointer transition-colors relative',
        isSelected ? 'bg-[hsl(50,100%,50%)] text-black dark:bg-[#F5C518]/20 dark:text-[#F5C518] dark:border-y dark:border-[#F5C518]/50 shadow-inner' : 'text-white hover:bg-white/10'
      )}
    ...
    >
        ...
        {onDesignationChange ? (
           <Input
            ...
            className={cn(
              ...
              isSelected ? 'text-black dark:text-white focus:bg-white/50 dark:focus:bg-[#F5C518]/20' : 'text-white focus:bg-white/20'
            )}
          />
        ) : (
      ...
      <NavigableCell row={index} column="price" className="px-1 py-0.5 border-r border-white/20 flex items-center">
        {item.priceTiers && onRowTierChange && enablePriceTiers && (
          <DropdownMenu>
            ...
            <DropdownMenuContent align="start" className="dark:bg-[#111111] dark:border-[#F5C518]/25 dark:text-white">
              <DropdownMenuLabel className="dark:text-[#F5C518]">Item Price Tier</DropdownMenuLabel>
              <DropdownMenuSeparator className="dark:bg-[#F5C518]/20" />
              <DropdownMenuItem onClick={() => onRowTierChange(index, 1)} className="dark:hover:bg-[#F5C518]/10 cursor-pointer">
              ...
              <DropdownMenuItem onClick={() => onRowTierChange(index, 2)} className="dark:hover:bg-[#F5C518]/10 cursor-pointer">
              ...
              <DropdownMenuItem onClick={() => onRowTierChange(index, 3)} className="dark:hover:bg-[#F5C518]/10 cursor-pointer">
              ...
              <DropdownMenuItem onClick={() => onRowTierChange(index, 4)} className="dark:hover:bg-[#F5C518]/10 cursor-pointer">
        ...
        {onPriceChange ? (
           <div className="relative flex-1 group h-full">
              <Input
                ...
                className={cn('h-full w-full p-1 text-right border-none font-mono text-sm bg-transparent tabular-nums focus:ring-0', isSelected ? 'text-black dark:text-white focus:bg-white/50 dark:focus:bg-[#F5C518]/20' : 'text-white focus:bg-white/20')}
              />
      ...
      <NavigableCell row={index} column="quantity" className="px-1 py-0.5 border-r border-white/20">
        <Input
          ...
          className={cn('h-6 w-full text-center text-sm p-0 border-none', isSelected ? 'bg-white text-black dark:bg-[#1A1A1A] dark:text-white' : 'bg-transparent text-white')}
        />
      </NavigableCell>
