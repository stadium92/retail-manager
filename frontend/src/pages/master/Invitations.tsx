...
export default function InvitationsPage() {
  ...
  const { selectedStoreIds, isAllStoresSelected, version } = useMasterDashboardStore(); // <--- Get state
          ...
          {invitations.length === 0 ? (
            ...
            <div className="overflow-auto max-h-[60vh]">
              <Table>
                ...
                <TableBody>
                  {invitations
                    .filter(inv => isAllStoresSelected || (inv.store_id && selectedStoreIds.includes(inv.store_id)))
                    .map((invitation) => (
