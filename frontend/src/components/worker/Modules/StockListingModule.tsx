  ...
  return (
    <div className="h-full flex flex-col p-4 bg-[hsl(60,80%,85%)] dark:bg-transparent">
      ...
      <div className="flex-1 glass-card overflow-hidden">
        {/* Table Header */}
        <div className="grid grid-cols-[80px_1fr_120px_100px_100px_100px_120px] gap-2 px-4 py-2 bg-muted/50 border-b border-border/50 text-xs font-medium text-muted-foreground uppercase">
          ...
          {filteredProducts.map((product) => {
            ...
            return (
              <div
                ...
                className={cn(
                  'grid grid-cols-[80px_1fr_120px_100px_100px_100px_120px] gap-2 px-4 items-center',
