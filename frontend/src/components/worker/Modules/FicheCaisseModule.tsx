        ...
        <div className="glass-card p-4">
          ...
          <div className="flex flex-wrap items-center gap-4 md:gap-8 mb-6 p-3 bg-muted/30 rounded-lg">
            <div className="flex items-center gap-2">
              ...
              <Input 
                value="" 
                className="w-20 h-8 bg-success/30 dark:bg-emerald-950/40 dark:text-emerald-300 dark:border-emerald-900/50"
                readOnly
              />
            </div>
            <div className="flex items-center gap-2">
              ...
              <Input 
                ...
                className="w-40 h-8 dark:bg-[#1A1A1A] dark:border-[#F5C518]/20 dark:text-white"
              />
            </div>
            <div className="flex items-center gap-2">
              ...
              <Input 
                ...
                className="w-28 h-8 bg-success/30 dark:bg-emerald-950/40 dark:text-emerald-300 dark:border-emerald-900/50"
                readOnly
              />
            </div>
            <div className="flex items-center gap-2">
              ...
              <Input className="w-20 h-8 bg-success/30 dark:bg-emerald-950/40 dark:text-emerald-300 dark:border-emerald-900/50" />
            </div>
            <div className="flex items-center gap-2">
              ...
              <NumericInput 
                ...
                className="w-24 h-8 bg-success/30 dark:bg-emerald-950/40 dark:text-emerald-300 dark:border-emerald-900/50 text-right"
              />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.5fr_auto] gap-6">
            {/* Left: Billetage */}
            <div>
              <div className="bg-[hsl(300,70%,60%)] text-white px-3 py-1 rounded-t-lg font-bold text-sm dark:bg-[#F5C518]/15 dark:text-[#F5C518] dark:border dark:border-[#F5C518]/30">
                {t('menu.program.cashCounting')}
              </div>
              <div className="border border-border rounded-b-lg p-3 bg-card/50 dark:border-[#F5C518]/15 dark:bg-[#0D0D0D]">
                <div className="grid grid-cols-[auto_1fr_auto_1fr] gap-2 items-center text-sm">
                  ...
                  {bills.map((bill) => (
                    <div key={`bill-${bill.denomination}`} className="contents">
                      <NumericInput 
                        ...
                        integer
                        className="w-12 h-7 text-center bg-success/30 dark:bg-emerald-950/40 dark:text-emerald-300 dark:border-emerald-900/50"
                      />
                  ...
                  <NumericInput 
                    ...
                    integer
                    className="w-20 h-7 text-right bg-success/30 dark:bg-emerald-950/40 dark:text-emerald-300 dark:border-emerald-900/50"
                  />
                </div>
                
                <div className="border-t border-dashed border-border dark:border-[#F5C518]/25 mt-3 pt-3">
                  <div className="flex justify-between items-center">
                    <span className="font-bold">{t('worker.sales.total')} .....=</span>
                    <Input 
                      value={formatCurrency(billTotal)}
                      className="w-28 h-8 text-right bg-success/30 dark:bg-emerald-950/40 dark:text-emerald-300 dark:border-emerald-900/50 font-bold"
                      readOnly
                    />
                  </div>
                  <div className="flex justify-between items-center mt-2">
                    <span className="font-medium">{t('menu.program.hqTransfer')} ....:</span>
                    <Input className="w-28 h-8 text-right dark:bg-[#1A1A1A] dark:border-[#F5C518]/20" />
                  </div>
                </div>
              </div>
            </div>
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <Input 
                      ...
                      className="w-28 h-7 text-right bg-success/30 dark:bg-emerald-950/40 dark:text-emerald-300 dark:border-emerald-900/50"
                      readOnly
                    />
                  </div>
                  <div className="flex justify-between items-center">
                  ...
                  <div className="border-t border-dashed border-border dark:border-[#F5C518]/25 mt-3 pt-3">
                    <div className="flex justify-between items-center">
                      <span className="font-bold text-[hsl(300,70%,50%)] dark:text-[#F5C518]">{t('worker.sales.total')} {t('menu.program.collections')}....:</span>
                      <Input 
                  ...
                  <div className="flex justify-between items-center mt-2">
                    ...
                    <NumericInput 
                      ...
                      className="w-28 h-7 text-right dark:bg-[#1A1A1A] dark:border-[#F5C518]/20"
                    />
                  </div>
                  <div className="flex justify-between items-center">
                    ...
                    <Input 
                      ...
                      className="w-40 h-7 dark:bg-[#1A1A1A] dark:border-[#F5C518]/20"
                    />
                  </div>
                </div>
              </div>
            ...
            <div className="w-full lg:w-48">
              <div className="bg-[hsl(300,70%,60%)] text-white px-3 py-1 rounded-t-lg font-bold text-sm text-center dark:bg-red-950/40 dark:text-red-400 dark:border dark:border-red-900/50">
                {t('menu.program.computer')}
              </div>
              <div className="border border-border dark:border-red-900/30 rounded-b-lg p-3 bg-danger dark:bg-red-950/20 text-danger-foreground dark:text-red-400">
          ...
          <div className="mt-4">
            <div className="flex flex-col md:flex-row items-start md:items-center gap-3">
              ...
              <Input 
                ...
                className="flex-1 h-8 bg-success/30 dark:bg-[#1A1A1A] dark:border-[#F5C518]/20 dark:text-white"
                placeholder="..."
              />
            </div>
          </div>
